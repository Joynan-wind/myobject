...
urlpatterns = [
    ...
    # 店铺路由
    path('shop/index/<int:pIndex>',shop.index,name="myadmin_shop_index"),
    ...
    path('category/delete/<int:cid>', category.delete, name='myadmin_category_delete'),
    ...
    path('product/delete/<int:pid>', product.delete, name="myadmin_product_delete"),
